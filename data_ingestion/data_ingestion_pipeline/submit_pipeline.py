...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--gcs-input-bucket",
        default=os.getenv("GCS_INPUT_BUCKET"),
        help="GCS bucket for input documents",
    )
    parser.add_argument(
        "--gcs-input-prefix",
        default=os.getenv("GCS_INPUT_PREFIX", "kb_documents/"),
        help="GCS prefix for input documents",
    )
...
if __name__ == "__main__":
    ...
    pipeline_job_params["parameter_values"]["gcs_input_bucket"] = args.gcs_input_bucket
    pipeline_job_params["parameter_values"]["gcs_input_prefix"] = args.gcs_input_prefix
